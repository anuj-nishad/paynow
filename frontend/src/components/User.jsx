...
export function User({userId}) {
  ...
  return (
    ...
    <div className='bg-white rounded-xl flex flex-col justify-center font-poppins px-6 sm:px-8 py-8 pb-10 shadow-xl h-auto mt-5'>
      ...
      <input type="text" placeholder="Search users..." className="border-b mt-4 outline-none py-2" onChange={handleFilter} />
      <div className="mt-2">
    {users.map((user)=>(
      <div key={user.id} className="flex items-center justify-between mt-6 sm:mt-5 pb-3 sm:pb-3 border-b-2">
